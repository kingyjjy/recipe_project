    ...
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
        <div className="flex items-center">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
                YJJY's <span className="font-bold">요리교실</span>
            </h1>
        ...
        <div className="bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]">
            ...
            <input type="text" className="bg-transparent p-2 w-full focus:outline-none" placeholder='레시피 검색'/>
        </div>
        ...
        <div className={sideNav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300 ' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
            ...
            <h2 className="text-2xl p-4">YJJY's <span className="font-bold">요리교실</span></h2>
            <nav>
